...
const routes: Routes = [
    ...
    { path: 'cph-receive', loadChildren: './pages/cph-receive/cph-receive.module#PocReceivePageModule' },
    { path: 'cph-send', loadChildren: './pages/cph-send/cph-send.module#PocSendPageModule' },
