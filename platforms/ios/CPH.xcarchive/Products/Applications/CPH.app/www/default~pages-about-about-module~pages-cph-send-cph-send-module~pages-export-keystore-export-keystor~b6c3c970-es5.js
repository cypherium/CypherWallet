      ...
      _createClass(NativeService, [{
        ...
        value: function getAppVersionInfo() {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
            Promise.all([_this.appVersion.getAppName(), _this.appVersion.getPackageName(), _this.appVersion.getVersionNumber()]).then(function (result) {
              appInfo.appName = result[0];
              appInfo.packageName = result[1];
              appInfo.versionNumber = result[2];
              appInfo.name = result[1].split('.').pop();
              _this.AppVersionInfo = appInfo;
        ...
        */
        ...
        value: function getVersionNumber() {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
            if (_this2.helper.isMobile()) {
              _this2.appVersion.getVersionNumber().then(function (value) {
                observer.next(value);
              }).catch(function (err) {
        ...
        value: function getAppName() {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
            if (_this3.helper.isMobile()) {
              _this3.appVersion.getAppName().then(function (value) {
                observer.next(value);
              }).catch(function (err) {
        ...
        value: function getPackageName() {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
            if (_this4.helper.isMobile()) {
              _this4.appVersion.getPackageName().then(function (value) {
                observer.next(value);
              }).catch(function (err) {
...
//# sourceMappingURL=default~pages-about-about-module~pages-cph-send-cph-send-module~pages-export-keystore-export-keystor~b6c3c970-es5.js.map