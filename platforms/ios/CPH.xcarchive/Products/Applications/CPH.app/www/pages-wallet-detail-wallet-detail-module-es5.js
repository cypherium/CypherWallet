...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-wallet-detail-wallet-detail-module"], {
  ...
  function srcAppPagesWalletDetailWalletDetailPageTs(module, __webpack_exports__, __webpack_require__) {
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.http.get(this.global.api['getRateInfo']).subscribe(function (res) {
                      ...
                      var amountInOtherFraction = Math.floor(_this4.amountInOther * mod) % mod;
                      ...
                      _this4.amountInOtherDisplay = amountInOtherInterger + '.' + amountInOtherFraction;
                    });
                    ...
                    return _context2.abrupt("return", this.http.post(url, {
                      ...
                      if (res.err_no == 0) {
                        ...
                        if (res.transactions) {
                          ...
                          var transactionsRes = [];
                          res.transactions.forEach(function (item) {
                            if (item.tx_type === 1 && item.from === item.to && _this5.type === 2) {
                              item.tx_type = 2;
                            } else if (item.tx_type === 1 && item.from === item.to && _this5.type === 0) {
                          ...
                          if (_this5.pageno === 1) {
                            _this5.allTransactionList = transactionsRes || [];
                          } else {
                            _this5.allTransactionList = _this5.allTransactionList.concat(transactionsRes || []);
                          } // this.more = (this.allTransactionList.length < res.count);


                          if (Object.keys(res.transactions).length == _this5.pageSize) {
                            _this5.more = true;
                          } else {
                            _this5.more = false;
                          }

                          console.log(_this5.allTransactionList.length, res.count);
                        } else {
                          if (_this5.pageno > 1) {
                            _this5.pageno--;
                          } else {
                            _this5.allTransactionList = [];
                          }
                      ...
                      _this5.helper.toast("The network is abnormal, please visit later.");
                    }));
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_global_global_service__WEBPACK_IMPORTED_MODULE_2__["GlobalService"], _providers_http_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"], _providers_web3_web3_service__WEBPACK_IMPORTED_MODULE_4__["Web3Service"], _providers_helper_helper_service__WEBPACK_IMPORTED_MODULE_6__["HelperService"], _providers_native_native_service__WEBPACK_IMPORTED_MODULE_7__["NativeService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["NavController"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])], WalletDetailPage);
    /***/
  }
}]);
