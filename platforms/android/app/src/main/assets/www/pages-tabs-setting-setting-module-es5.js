...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tabs-setting-setting-module"], {
  ...
  function srcAppPagesTabsSettingSettingPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SettingPage(router, global, storage, helper, http, httpn, activeRouter, navCtrl) {
      ...
      _createClass(SettingPage, [{
        ...
        key: "goChangePaymentPassword",
        value: function goChangePaymentPassword() {
          var _this3 = this;
          ...
          this.confirmPrompt = function (prv) {
            ...
            _this3.router.navigate(['payment-password'], navigationExtras);
          };
        }
      }]);
